...
const std::vector<int> heatMapKey = {
    -2, //OrbitHeat_Searing,
    -1, //OrbitHeat_Hot,
     0, //OrbitHeat_Warm,
     0, //OrbitHeat_Cool,
...
//result is used to index into the karstSubterraneanOracles
std::vector<OracleEntry> karstSurfaceTypeOracle = {
    { PlanetType_Furnace,      1, 12,  "0"},
    { PlanetType_Metallic,    13, 17,  "1"},
    { PlanetType_Rocky,       18, 32,  "2"},
    { PlanetType_Crystalline, 33, 37,  "3"},
    { PlanetType_Desert,      38, 49,  "4"},
    { PlanetType_Tainted,     50, 60,  "5"},
    { PlanetType_Jungle,      61, 71,  "6"},
    { PlanetType_Vital,       72, 77,  "7"},
    { PlanetType_Grave,       78, 87,  "8"},
    { PlanetType_Ice,         88, 100, "9"},
};


std::array<std::vector<OracleEntryND>, 10> karstSubterraneanOracles{ {
	// PlanetType_Furnace
	std::vector<OracleEntryND>{
		{ PlanetType_Metallic,       1, 15 },
		{ PlanetType_Rocky,       16, 27 },
		{ PlanetType_Crystalline,       28, 37 },
		{ PlanetType_Desert,       38, 45 },
		{ PlanetType_Tainted,       46, 51 },
		{ PlanetType_Jungle,       52, 55 },
		{ PlanetType_Vital,       56, 59 },
		{ PlanetType_Grave,       60, 63 },
		{ PlanetType_Ocean,       64, 73 },
		{ PlanetType_Ice,       74, 85 },
		{ PlanetType_Chemical,       86, 100 },
	},
	// PlanetType_Metallic
	std::vector<OracleEntryND>{
		{ PlanetType_Furnace,       1, 15 },
		{ PlanetType_Rocky,       16, 27 },
		{ PlanetType_Crystalline,       28, 37 },
		{ PlanetType_Desert,       38, 45 },
		{ PlanetType_Tainted,       46, 51 },
	...
	std::vector<OracleEntryND>{
		...
		{ PlanetType_Jungle,       56, 59 },
		{ PlanetType_Vital,       60, 63 },
		{ PlanetType_Grave,       64, 73 },
		{ PlanetType_Ocean,       74, 85 },
		{ PlanetType_Chemical,       86, 100 },
    },
...
//result is used to index into the karstSubterraneanOracles
std::vector<OracleEntry> tidallyLockedLightSideTypeOracle = {
    { PlanetType_Furnace,      1, 13,  "0"},
    { PlanetType_Metallic,    14, 17,  "1"},
    { PlanetType_Rocky,       18, 23,  "2"},
    { PlanetType_Crystalline, 24, 27,  "3"},
    { PlanetType_Desert,      28, 40,  "4"},
    { PlanetType_Tainted,     41, 52,  "5"},
    { PlanetType_Jungle,      53, 64,  "6"},
    { PlanetType_Vital,       65, 76,  "7"},
    { PlanetType_Grave,       77, 88,  "8"},
    { PlanetType_Ocean,       89, 100, "9"},
};

std::vector<OracleEntry> tidallyLockedDarkSideTypeLoookup = {
    { PlanetType_Furnace,     0, 0, "0"},
    { PlanetType_Metallic,    0, 0, "1"},
    { PlanetType_Rocky,       0, 0, "2"},
    { PlanetType_Crystalline, 0, 0, "3"},
    { PlanetType_Desert,      0, 0, "4"},
    { PlanetType_Tainted,     0, 0, "5"},
    { PlanetType_Jungle,      0, 0, "6"},
    { PlanetType_Vital,       0, 0, "7"},
    { PlanetType_Grave,       0, 0, "8"},
    { PlanetType_Ocean,       0, 0, "9"},
    { PlanetType_Ice,         0, 0, "10"},
    { PlanetType_Chemical,    0, 0, "11"},
};

std::array<std::vector<OracleEntryND>, 10> tidallyLockedDarkSideTypeOracles{ {
	// PlanetType_Furnace
	std::vector<OracleEntryND>{
        { PlanetType_Rocky,       1, 23 },
        { PlanetType_Crystalline,       24, 40 },
        { PlanetType_Desert,       41, 55 },
        { PlanetType_Tainted,       56, 67 },
        { PlanetType_Jungle,       68, 76 },
        { PlanetType_Vital,       77, 84 },
        { PlanetType_Grave,       85, 91 },
        { PlanetType_Ocean,       92, 96 },
        { PlanetType_Ice,       97, 99 },
        { PlanetType_Chemical,       100, 100 },
	},
	// PlanetType_Metallic
	std::vector<OracleEntryND>{
        { PlanetType_Crystalline,       1, 23 },
        { PlanetType_Desert,       24, 41 },
        { PlanetType_Tainted,       42, 56 },
        { PlanetType_Jungle,       57, 68 },
        { PlanetType_Vital,       69, 77 },
        { PlanetType_Grave,       78, 85 },
        { PlanetType_Ocean,       86, 92 },
        { PlanetType_Ice,       93, 97 },
        { PlanetType_Chemical,       98, 100 },
	},
	// PlanetType_Rocky
	std::vector<OracleEntryND>{
        { PlanetType_Furnace,       1, 17 },
        { PlanetType_Desert,       18, 34 },
        { PlanetType_Tainted,       35, 48 },
        { PlanetType_Jungle,       49, 60 },
        { PlanetType_Vital,       61, 70 },
        { PlanetType_Grave,       71, 79 },
        { PlanetType_Ocean,       80, 87 },
        { PlanetType_Ice,       88, 94 },
        { PlanetType_Chemical,       95, 100 },
	},
	// PlanetType_Crystalline
	std::vector<OracleEntryND>{
        { PlanetType_Furnace,       1, 13 },
        { PlanetType_Metallic,       14, 29 },
        { PlanetType_Tainted,       30, 45 },
        { PlanetType_Jungle,       46, 58 },
        { PlanetType_Vital,       59, 69 },
        { PlanetType_Grave,       70, 79 },
        { PlanetType_Ocean,       80, 87 },
        { PlanetType_Ice,       88, 94 },
        { PlanetType_Chemical,       95, 100 },
	},
	// PlanetType_Desert
	std::vector<OracleEntryND>{
        { PlanetType_Furnace,       1, 11 },
        { PlanetType_Metallic,       12, 23 },
        { PlanetType_Rocky,       24, 39 },
        { PlanetType_Jungle,       40, 55 },
        { PlanetType_Vital,       56, 67 },
        { PlanetType_Grave,       68, 78 },
        { PlanetType_Ocean,       79, 88 },
        { PlanetType_Ice,       89, 95 },
        { PlanetType_Chemical,       96, 100 },
	},
	// PlanetType_Tainted
	std::vector<OracleEntryND>{
        { PlanetType_Furnace,       1, 9 },
        { PlanetType_Metallic,       10, 19 },
        { PlanetType_Rocky,       20, 31 },
        { PlanetType_Crystalline,       32, 47 },
        { PlanetType_Vital,       48, 63 },
        { PlanetType_Grave,       64, 75 },
        { PlanetType_Ocean,       76, 85 },
        { PlanetType_Ice,       86, 94 },
        { PlanetType_Chemical,       95, 100 },
	},
	// PlanetType_Jungle
	std::vector<OracleEntryND>{
        { PlanetType_Furnace,       1, 6 },
        { PlanetType_Metallic,       7, 15 },
        { PlanetType_Rocky,       11, 25 },
        { PlanetType_Crystalline,       26, 37 },
        { PlanetType_Desert,       38, 53 },
        { PlanetType_Grave,       54, 69 },
        { PlanetType_Ocean,       70, 81 },
        { PlanetType_Ice,       82, 91 },
        { PlanetType_Chemical,       92, 100 },
	},
	// PlanetType_Vital
	std::vector<OracleEntryND>{
        { PlanetType_Furnace,       1, 5 },
        { PlanetType_Metallic,       6, 12 },
        { PlanetType_Rocky,       13, 22 },
        { PlanetType_Crystalline,       23, 33 },
        { PlanetType_Desert,       34, 45 },
        { PlanetType_Tainted,       46, 61 },
        { PlanetType_Ocean,       62, 77 },
        { PlanetType_Ice,       78, 89 },
        { PlanetType_Chemical,       90, 100 },
	},
	// PlanetType_Grave
	std::vector<OracleEntryND>{
        { PlanetType_Furnace,       1, 6 },
        { PlanetType_Metallic,       7, 13 },
        { PlanetType_Rocky,       14, 21 },
        { PlanetType_Crystalline,       22, 31 },
        { PlanetType_Desert,       32, 42 },
        { PlanetType_Tainted,       43, 55 },
        { PlanetType_Jungle,       56, 71 },
        { PlanetType_Ice,       72, 87 },
        { PlanetType_Chemical,       88, 100 },
	},
	// PlanetType_Ice
	std::vector<OracleEntryND>{
        { PlanetType_Furnace,       1, 6 },
        { PlanetType_Metallic,       7, 13 },
        { PlanetType_Rocky,       14, 21 },
        { PlanetType_Crystalline,       22, 30 },
        { PlanetType_Desert,       31, 40 },
        { PlanetType_Tainted,       41, 52 },
        { PlanetType_Jungle,       53, 66 },
        { PlanetType_Vital,       67, 83 },
        { PlanetType_Chemical,       84, 100 },
    },
} };
...
std::array<std::vector<OracleEntryND>, 10> tidallyLockedCentralBandSelectionOracles{ {
    // worlds in between = 1
    std::vector<OracleEntryND>{
        { 1, 1, 100 },
    },
...
std::array<std::vector<std::vector<OracleEntry>>, 18> BiomeFeatureTable{ {
...

    {
        ...
        { //{PlanetType_Desert, 1, "Dune"},
            {0, 1, 11, "Buried mountain peaks"},
            {1, 12, 22, "Enormous shifting dunes"},
            {2, 23, 33, "Fleeting springs emerging from the sands"},
            {3, 34, 44, "Landscape-altering flashfloods"},
            {4, 45, 55, "Sands roiling or rippling with static electricity"},
            {5, 56, 66, "Secluded patches of lush vegetation"},
            {6, 67, 77, "Symmetrical dune formations"},
            {7, 78, 88, "Windborne metallic or glimmering sand"},
        },
        { //{PlanetType_Desert, 2, "Mesa" },
            {0, 1, 11, "Ferocious river rapids"},
            {1, 12, 22, "Huge shrubs and grasses line the river banks"},
            {2, 23, 33, "Intricate networks of carved canyons"},
            {3, 34, 44, "Plateaus bristling with vegetation"},
            {4, 45, 55, "Precariously fragile stone columns"},
            {5, 56, 66, "Secluded grottos"},
            {6, 67, 77, "Slowly collapsing or eroding rock faces"},
            {7, 78, 88, "Vast mesas with tumbling waterfalls"},
        },
        { //{PlanetType_Desert, 3, "Oasis"},
            {1, 1, 11, "Colossal freshwater pools, lakes or rivers"},
