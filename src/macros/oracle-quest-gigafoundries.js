...
let title = "<h3><strong>Oracle Quest - Gigafoundries</strong></h3>";
let message = "A " + await rollOracle("Compendium.ancient-wonders.ancientwondersoracles.RollTable.mEWovsWhwKc4EYn4") + " settlement has been attempting to reactivate an offline gigafoundry themselves, as their " + await rollOracle("Compendium.ancient-wonders.ancientwondersoracles.RollTable.165pYBMpRkAewRXO") + " faction refuses to help with the endeavor. The community is looking for intrepid delvers to assist them, as they believe the reactivation will allow them to accomplish their " + await rollOracle("Compendium.ancient-wonders.ancientwondersoracles.RollTable.bEcncvEiOdNI2M2c") + " project. Why is the settlement's faction refusing to assist them? How will reactivating a gigafoundry help the settlement?"
