...
let title = "<h3><strong>Oracle Quest - Cylindrical Habitats</strong></h3>";
let message = "A " + await rollOracle("Compendium.ancient-wonders.ancientwondersoracles.RollTable.mEWovsWhwKc4EYn4") + " settlement residing within a conquered habitat cluster has requested aid in overcoming a " + await rollOracle("Compendium.ancient-wonders.ancientwondersoracles.RollTable.ltMg2rFljXANmPqy") + " infesting one of the cylinders; a plague they believe originated from a " + await rollOracle("Compendium.ancient-wonders.ancientwondersoracles.RollTable.e2bae1632870e2d2") + " "  + await rollOracle("Compendium.ancient-wonders.ancientwondersoracles.RollTable.TfBWJ7oJW2ASVapV") + ". Time is of the essence. The anomalous plague is spreading. How will you prevent catastrophe? How did this community settle here in the first place?"
